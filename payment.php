    ...
    if(empty($api_error) && $plan){ 
        ...
        if(empty($api_error) && $subscription){ 
            ...
            if($subsData['status'] == 'active'){ 
                ...
                $sql = "INSERT INTO users (subscription_id,first_name,last_name,email,password,phone,created,modified,status) VALUES('".$subscrID."','".$first_name."','".$last_name."','".$email."','".$password."','".$phone."','".$created."','".$created."','".$status."')"; 
                print_r($sql);
                // exit;
                $insert = $db->query( $sql);  
